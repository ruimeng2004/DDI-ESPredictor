...
class SchNet(torch.nn.Module):
    ...
    """
    def __init__(self, energy_and_force=False, cutoff=10.0, num_layers=3, hidden_channels=128, out_channels=128, num_filters=128, num_gaussians=50):
        ...
        self.init_v = Embedding(120, hidden_channels) # 119+1
